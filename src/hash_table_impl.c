...
#define MAKE_HASH_TABLE_DELETE_NAME(x) x ## _delete(x* this)
#define GEN_HASH_TABLE_DELETE_NAME(x) MAKE_HASH_TABLE_DELETE_NAME(x)
void GEN_HASH_TABLE_DELETE_NAME(HASH_TABLE)
{
    if (this == NULL) return;
...
#undef GEN_HASH_TABLE_DELETE_NAME
#undef MAKE_HASH_TABLE_DELETE_NAME
