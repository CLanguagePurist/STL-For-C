...
int Test_IndexOf1()
{
    ...
    list_int32_t_add(list, 2);
    list_int32_t_add(list, 3);
    if (list_int32_t_indexof(list, 1) != 0)
        return 1;
    if (list_int32_t_indexof(list, 2) != 1)
        return 2;
    if (list_int32_t_indexof(list, 3) != 2)
        return 3;
    list_int32_t_destroy(list);
    return 0;
}
...
int Test_IndexOf2()
{
    ...
    list_int32_t_add(list, 2);
    list_int32_t_add(list, 3);
    if (list_int32_t_indexof2(list, 1, 1) != -1)
        return 1;
    if (list_int32_t_indexof2(list, 1, 0) != 0)
        return 2;
    if (list_int32_t_indexof2(list, 2, 1) != 1)
        return 3;
    if (list_int32_t_indexof2(list, 2, 2) != -1)
        return 4;
    if (list_int32_t_indexof2(list, 3, 2) != 2)
        return 5;
    if (list_int32_t_indexof2(list, 3, 3) != -1)
        return 6;
    list_int32_t_destroy(list);
    return 0;
}
...
int Test_IndexOf3()
{
    ...
    list_int32_t_add(list, 2);
    list_int32_t_add(list, 3);
    if (list_int32_t_indexof3(list, 1, 0, 0) != -1)
        return 1;
    if (list_int32_t_indexof3(list, 1, 0, 4) != 0)
        return 2;
    if (list_int32_t_indexof3(list, 1, 0, 1) != 0)
        return 3;
    if (list_int32_t_indexof3(list, 1, 1, 1) != -1)
        return 4;
    
    if (list_int32_t_indexof3(list, 2, 1, 1) != 1)
        return 5;
    if (list_int32_t_indexof3(list, 2, 1, 0) != -1)
        return 6;
    if (list_int32_t_indexof3(list, 2, 0, 1) != -1)
        return 7;
    if (list_int32_t_indexof3(list, 2, 0, 2) != 1)
        return 8;
    if (list_int32_t_indexof3(list, 2, 2, 2) != -1)
        return 9;

    if (list_int32_t_indexof3(list, 3, 2, 1) != 2)
        return 10;
    if (list_int32_t_indexof3(list, 3, 1, 1) != -1)
        return 11;
    if (list_int32_t_indexof3(list, 3, 2, 0) != -1)
        return 12;
    if (list_int32_t_indexof3(list, 3, 0, 3) != 2)
        return 13;
    if (list_int32_t_indexof3(list, 3, 1, 2) != 2)
        return 14;
    list_int32_t_destroy(list);
    return 0;
}
...
int Test_Get()
{
    ...
    list_int32_t_add(list, 3);
    int result;
    if (list_int32_t_get(list, 0, &result)) return 1;
    if (result != 1) return 2;
    result = -1;
    if (list_int32_t_get(list, 1, &result)) return 3;
    if (result != 2) return 4;
    result = -1;
    if (list_int32_t_get(list, 2, &result)) return 5;
...
int Test_GetRange()
{
    ...
    if (memcmp(result, list->items, list->size * sizeof(int)) != 0)
        return 3;
    free(result);
    if (list_int32_t_getrange(list, 1, 1, &result))
        return 4;
    if (result[0] != 1)
        return 5;
    free(result);
...
int Test_AddRange()
{
    ...
    for (int i = 0; i < 1024; ++i)
        sample[i] = i + 1;
    if (list_int32_t_addrange(list, &sample[512], 512)) return 1;
    if (list->items[0] != 513) return 2;
    if (list->items[511] != 1024) return 3;
    if (list_int32_t_addrange(list, sample, 512)) return 4;
...
int Test_AddRange_At()
{
    ...
    // 0 ... 512
    if (list_int32_t_addrange_at(list, 0, sample, 512)) return 1;
    if (list->items[0] != 0) return 2;
    if (list->items[511] != 511) return 3;
    // 0 .. 255, 512 .. 1023, 256 .. 511
    if (list_int32_t_addrange_at(list, 256, &sample[512], 512)) return 4;
...
int Test_Remove()
{
    ...
    list_int32_t_add(list, 2);
    list_int32_t_add(list, 3);
    if (list_int32_t_remove(list, 0)) return 1;
    if (list->size != 2) return 2;
    if (list->items[0] != 2) return 3;
    if (list->items[1] != 3) return 4;
    if (list_int32_t_remove(list, 0)) return 5;
    if (list->items[0] != 3) return 6;
    if (list->size != 1) return 7;
    if (list_int32_t_remove(list, 0)) return 8;
    if (list->size != 0) return 9;
    if (list_int32_t_remove(list, 0)) return 10;
    list_int32_t_destroy(list);
    return 0;
}
...
int Test_RemoveRange()
{
    ...
    if (list_int32_t_count(list) != 1024) return 1;
    
    // 2 .. 1023
    if (list_int32_t_removerange(list, 0, 2)) return 2;
    if (list->items[0] != 2) return 3;
    if (list->size != 1022) return 4;

    // 2 .. 102, 104 .. 1023
    if (list_int32_t_removerange(list, 100, 2)) return 5;
    if (list->items[99] != 101) return 6;
    if (list->items[100] != 104) return 7;
    if (list->items[101] != 105) return 8;
    if (list->size != 1020) return 9;

    if (list_int32_t_removerange(list, 1019, 100)) return 10;
...
int Test_RemoveItem()
{
    ...
    if (list_int32_t_remove_item(list, 2)) return 1;
    if (list->size != 2) return 2;
    if (list->items[0] != 1) return 3;
    if (list->items[1] != 3) return 4;

    if (list_int32_t_remove_item(list, 1)) return 5;
    if (list->size != 1) return 6;
    if (list->items[0] != 3) return 7;
    
    if (list_int32_t_remove_item(list, 3)) return 8;
    
    if (list->size != 0) return 9;
    if (!list_int32_t_remove_item(list, 0)) return 10;
...
int Test_IncorrectData()
{
    list_int32_t* list = list_int32_t_new();
    int32_t output;
    if (!list_int32_t_get(list, 0, &output)) return 1;
    list_int32_t_destroy(list);
    return 0;
}
...
int Test_Reallocation()
{
    ...
    for (int i = 0; i < 1024; ++i)
    {
        if (list_int32_t_add(list, i)) return 1;
    }
    if (list_int32_t_count(list) != 1024) return 2;
    if (list->size != 1024) return 3;
    if (list->capacity < list->size) return 4;
    
    if (list_int32_t_removerange(list, 254, 769)) return 5;
